...
#define CANCEL_BUTTON_COLOR                     [UIColor colorWithRed:217.0/255.00f green:217.0/255.00f blue:217.0/255.00f alpha:1]
...
- (void)creatButtonsWithTitle:(NSString *)title cancelButtonTitle:(NSString *)cancelButtonTitle destructionButtonTitle:(NSString *)destructiveButtonTitle otherButtonTitles:(NSArray *)otherButtonTitlesArray
{
    ...
    self.backGroundView.backgroundColor = [UIColor colorWithWhite:0.95 alpha:1.0];//ACTIONSHEET_BACKGROUNDCOLOR;
...
{
    UILabel *titlelabel = [[UILabel alloc] initWithFrame:CGRectMake(TITLE_INTERVAL_WIDTH, TITLE_INTERVAL_HEIGHT, self.bounds.size.width - 2 * TITLE_INTERVAL_WIDTH, TITLE_HEIGHT)];
...
{
    UIButton *destructiveButton = [[UIButton alloc] initWithFrame:CGRectMake(BUTTON_INTERVAL_WIDTH, BUTTON_INTERVAL_HEIGHT, self.bounds.size.width - BUTTON_INTERVAL_WIDTH * 2, BUTTON_HEIGHT)];
    ...
    destructiveButton.backgroundColor = [UIColor colorWithRed:15.0/255.0 green:120.0/255.0 blue:203.0/255.0 alpha:1.0];//DESTRUCTIVE_BUTTON_COLOR;
...
{
    UIButton *cancelButton = [[UIButton alloc] initWithFrame:CGRectMake(BUTTON_INTERVAL_WIDTH, BUTTON_INTERVAL_HEIGHT, self.bounds.size.width - 2 * BUTTON_INTERVAL_WIDTH, BUTTON_HEIGHT)];
    ...
    cancelButton.backgroundColor = [UIColor lightGrayColor];//CANCEL_BUTTON_COLOR;
